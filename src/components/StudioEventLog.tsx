...
/** Studio-flavored event log. Reads from `activeStudioVenture.events`. */
export function StudioEventLog({ limit = 8 }: { limit?: number }) {
  const events = useGame(s => s.activeStudioVenture?.events ?? []);
